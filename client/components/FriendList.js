        ...
        <Grid className="flex-grid">
          {acceptedFriendRequest.length
              ? acceptedFriendRequest.map((friendRequest) => {
                  ...
                  return (
                    <Card className="friend-card" key={friend.id} sx={{ width: 250, height: 300 }}>
                      <CardMedia
                      component="img"
                      alt="No profile pic"
                      height="140"
                      ...
                      <CardContent>
                        ...
                        <Button style={{marginBottom: '.5rem', background: "#5e387c", color: 'white', padding: '.25rem', marginTop: '.5rem', borderRadius: "10px", marginRight:'auto',}}> 
                          Send Message 
                        </Button>
                        </Link>
                      </CardContent>
